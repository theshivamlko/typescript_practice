...
var user6 = user2 !== null && user2 !== void 0 ? user2 : 'DEFAULT'; // here user1 is empty so default
console.log(user1 !== null && user1 !== void 0 ? user1 : 'user1 default value'); // check null or undefined
console.log(user2 !== null && user2 !== void 0 ? user2 : 'user2 default value');
console.log(user4 !== null && user4 !== void 0 ? user4 : 'user4 default value');
console.log(user5 !== null && user5 !== void 0 ? user5 : 'user5 default value');
console.log(user6 !== null && user6 !== void 0 ? user6 : 'user6 default value');
// Generics
